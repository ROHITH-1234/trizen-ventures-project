      ...
      <div id="products-section" className="w-full py-4 md:py-8">
        <div className="w-full px-2 sm:px-4 md:px-6 lg:px-6 xl:px-8">
          <div className="flex flex-col md:flex-row gap-4 md:gap-6 lg:gap-8">
            ...
            <aside className="hidden md:block w-56 md:w-60 lg:w-64 shrink-0">
              <Filters
              ...
              <div className="mb-4 md:mb-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      {searchQuery && (
                        <button
                          ...
                          className="px-3 py-1 text-xs sm:text-sm bg-red-500 hover:bg-red-600 text-white rounded-full font-medium transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center gap-1.5 shadow-md"
                        >
                  ...
                  <select 
                    ...
                    className="w-full sm:w-auto px-3 sm:px-4 py-2 sm:py-2.5 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white font-medium text-sm sm:text-base text-gray-700 cursor-pointer hover:border-blue-400 transition-colors"
                  >
      ...
      <footer className="bg-gray-900 text-white mt-16">
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-xl font-bold">Trizen Ventures</h3>
              </div>
              <p className="text-gray-400">
                From Vision to Venture. Empowering individuals and organizations through innovation and education.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2025 Trizen Ventures. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
